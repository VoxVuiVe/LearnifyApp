...
public class MessageKeys {
    public static final String UPLOAD_IMAGES_MAX_1 = "user.upload_images.error_max_1_image";
    public static final String UPLOAD_IMAGES_FILE_LARGE = "user.upload_images.file_large";
    public static final String UPLOAD_IMAGES_FILE_MUST_BE_IMAGE = "user.upload_images.file_must_be_image";
