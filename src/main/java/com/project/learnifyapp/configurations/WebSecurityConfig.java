        ...
        httpSecurity
                ...
                .authorizeHttpRequests(requests -> {
                    requests
                            ...
                            //Categories
                            .requestMatchers(HttpMethod.POST, String.format("%s/categories/**", apiPrefix)).permitAll()
                            .requestMatchers(HttpMethod.PUT, String.format("%s/categories/**", apiPrefix)).permitAll()
                            .requestMatchers(HttpMethod.DELETE, String.format("%s/categories/**", apiPrefix)).permitAll()
...
//                            .requestMatchers(HttpMethod.DELETE, String.format("%s/role/**", apiPrefix)).permitAll()
                            ...
                            .requestMatchers(HttpMethod.PUT, String.format("%s/users**", apiPrefix)).permitAll()
...
//                            .requestMatchers(HttpMethod.GET, String.format("%s/users/image**", apiPrefix)).permitAll()
                            .anyRequest()
                            .authenticated();
                });
